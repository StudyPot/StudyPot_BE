...
public class AuthSessionService {
	...
	public AuthTokenResult loginWithGoogle(GoogleOAuthLoginCommand command, AuthSessionMetadata metadata) {
		...
		AuthUser user = findActiveUser(loginResult.userId());
	...
	public AuthTokenResult refresh(String rawRefreshToken, AuthSessionMetadata metadata) {
		...
		AuthUser user = findActiveUser(currentSession.userId());
	...
	private AuthTokenResult issueTokenPair(AuthUser user, AuthSessionMetadata metadata, Instant now) {
	...
	private AuthUser findActiveUser(UUID userId) {
		return authRepository.findActiveUser(userId)
