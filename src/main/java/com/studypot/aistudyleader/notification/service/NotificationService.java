...
public class NotificationService implements NotificationEventPublisher {
	...
	public void publishOnboardingRequested(UUID groupId, UUID recipientUserId) {
		publishAfterCommit(onboardingRequested(groupId, recipientUserId));
	}
	...
	public void publishWeekStarted(UUID groupId, UUID weekId, int weekNumber, String weekTitle) {
		...
		publishAfterCommit(() -> {
			...
			for (UUID recipientUserId : recipients) {
				createNotificationSafely(weekStarted(groupId, recipientUserId, weekId, weekNumber, safeWeekTitle));
			}
		});
	}
	...
	public void publishTaskDueReminder(
		...
		publishAfterCommit(taskNotification(
	...
	public void publishRetrospectiveReady(UUID groupId, UUID recipientUserId, UUID retrospectiveId, UUID weekId) {
		publishAfterCommit(retrospectiveNotification(
	...
	private static CreateNotificationCommand onboardingRequested(UUID groupId, UUID recipientUserId) {
	...
	private static CreateNotificationCommand weekStarted(
		UUID groupId,
		UUID recipientUserId,
		UUID weekId,
		int weekNumber,
	...
	private static CreateNotificationCommand taskNotification(
	...
	private static CreateNotificationCommand retrospectiveNotification(
		NotificationType type,
		UUID groupId,
		UUID recipientUserId,
