...
- Change records: [CR-20260504-no-discord-inapp-notification](./change-requests/CR-20260504-no-discord-inapp-notification.md), [CR-20260602-ready-to-start-status](./change-requests/CR-20260602-ready-to-start-status.md)
...
- Host start requires `study_group.status = READY_TO_START` and uses onboarding responses submitted at that moment.
