...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `identity-core` | `prd-v1.md` | `REQ-ID-001` to `REQ-ID-002` | `api-contract-v1.md`, `openapi.yaml` | `users`, `oauth_account`, `refresh_token` | `auth-permissions-v1.md` | `QA-ID-001` to `QA-ID-006` | Not started | Not started | Planned |
