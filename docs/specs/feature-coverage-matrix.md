...
| `study-group-core` | `prd-v1.md` | `REQ-GRP-001` to `REQ-GRP-002`, `REQ-INV-001` | `api-contract-v1.md`, `openapi.yaml` | `study_group`, `group_member` | `auth-permissions-v1.md` | `QA-GRP-001` to `QA-GRP-006` | Not started | Not started | Planned |
...
| `curriculum-core` | `prd-v1.md` | `REQ-CUR-001` to `REQ-CUR-002` | `api-contract-v1.md`, `openapi.yaml` | `curriculum`, `curriculum_week`, `weekly_task` | `ai-contract-v1.md` | `QA-CUR-001` to `QA-CUR-004` | `src/main/java/com/studypot/aistudyleader/curriculum` | `src/test/java/com/studypot/aistudyleader/curriculum` | In progress |
...
Fixed one-week sprint windows for `curriculum-core`, with `QA-CUR-004`, are approved by [CR-20260601-fixed-weekly-sprint-windows](./change-requests/CR-20260601-fixed-weekly-sprint-windows.md) and [ADR-20260601-fixed-weekly-sprint-windows](./adr/ADR-20260601-fixed-weekly-sprint-windows.md). The change derives week windows from the study group period, validates curriculum generation against the planned week count, and does not require an API or DB migration.
