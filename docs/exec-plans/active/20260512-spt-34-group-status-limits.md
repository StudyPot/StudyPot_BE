...
- [x] CodeRabbit review fix verification: `./gradlew test --tests com.studypot.aistudyleader.studygroup.service.StudyGroupServiceTest --tests com.studypot.aistudyleader.onboarding.service.OnboardingServiceTest --tests com.studypot.aistudyleader.onboarding.repository.JdbcOnboardingRepositoryTest --no-daemon`
