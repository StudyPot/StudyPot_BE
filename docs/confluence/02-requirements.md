...
## P0
- Group creation with name, topic, detail keywords, max members, and study period.
- Invite link/code join flow.
- Group-specific onboarding for host and members.
- Skill levels and task preferences use 1 to 5 scores.
- Availability slots store day/time/timezone.
- Host start creates AI curriculum.
