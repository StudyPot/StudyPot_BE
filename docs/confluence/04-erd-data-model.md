...
6. AI feedback writes `retrospective`, `ai_conversation`, `ai_conversation_message`, and `llm_usage`.
7. User-facing reminders and feedback alerts are recorded in `notification` with recipient/read state.
