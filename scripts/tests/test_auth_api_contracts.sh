...
assert_contains "QA-ID-006" "${TEST_ROOT}/docs/specs/qa-acceptance-v1.md"
assert_contains "QA-ID-001\` to \`QA-ID-006" "${TEST_ROOT}/docs/specs/feature-coverage-matrix.md"
