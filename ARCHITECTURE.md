...
- AI team leader behavior is asynchronous and stored through curriculum, retrospective, conversation, notification, and LLM usage records.
...
- DB/API/AI/Discord/권한 변경은 `docs/specs/change-control-v1.md`의 Change Request + ADR 기록을 먼저 확인한다.
