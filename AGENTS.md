...
- The v1 planning/API/DB/AI/Discord/permission/QA specs are `LOCKED_FOR_IMPLEMENTATION`. Changes are forbidden without the Change Request + ADR process in `docs/specs/change-control-v1.md`.
...
- Subagent review is optional support only when the user explicitly allows it.
